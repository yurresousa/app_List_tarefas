...
<html>
	...
	<script>
		...
		function remover(id){
			location.href = "todas_tarefas.php?pagina=todas_tarefas.php&acao=remover&id="+id;
		}

		function tarefaRealizada(id){	
			location.href = "todas_tarefas.php?pagina=todas_tarefas.php&acao=marcarRealizada&id="+id;
		}
	</script>
	</head>
